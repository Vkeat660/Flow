...
-(void)setupFontSize{
    ...
    if(self.traitCollection.horizontalSizeClass == UIUserInterfaceSizeClassRegular) {
        ...
        if(self.frame.size.width > 600){
            ...
            self.snipeLabel.font       = [UIFont fontWithName:@"HelveticaNeueLTStd-Hv" size:25.0];
            ...
            self.snipeLabel.font       = [UIFont fontWithName:@"HelveticaNeueLTStd-Hv" size:22.0];
            ...
            self.snipeLabel.font       = [UIFont fontWithName:@"HelveticaNeueLTStd-Hv" size:12.0];
